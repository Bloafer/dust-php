...
class SpecTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testChildTemplate() {
        $test = (object)array(
            ...
            "context" => (object)array("xhr" => false),
            "expected" => "Start\nChild Title\nChild Content\nEnd",
    ...
    public function testContext() {
        $test = (object)array(
            ...
            "context" => (object)array(
                ...
                "projects" => array(
                    (object)array("name" => "Mayhem"),
                    (object)array("name" => "Flash"),
                    (object)array("name" => "Thunder")
                )
            ),
            "expected" => "<ul>\n<li>Mayhem</li>\n<li>Flash</li>\n<li>Thunder</li>\n</ul>",
    ...
    public function testNullInTheContextTreatedAsEmpty() {
        $test = (object)array(
            ...
            "source" => "{NULL}",
            "context" => (object)array("NULL" => null),
            "expected" => "",
    ...
    public function testNullIsTreatedAsEmptyInExists() {
        $test = (object)array(
            ...
            "context" => (object)array("scalar" => null),
            "expected" => "false",
    ...
    public function testDustSyntaxError() {
        $test = (object)array(
            ...
            "source" => "RRR {##}",
            "context" => (object)array("name" => "Mick", "count" => 30),
    ...
    public function testScalarTrueValueInTheSection() {
        $test = (object)array(
            ...
            "source" => "{#scalar}true{:else}false{/scalar}",
            "context" => (object)array("scalar" => true),
            "expected" => "true",
    ...
    public function testPath() {
        $test = (object)array(
            "name" => "path",
            "source" => "{foo.bar}",
            "context" => (object)array("foo" => (object)array("bar" => "Hello!")),
            "expected" => "Hello!",
    ...
    public function testSupportDashInARefereceForExistsSection() {
        $test = (object)array(
            ...
            "context" => (object)array("tags-a" => "tag"),
            "expected" => "tag found!",
    ...
    public function testBufferDoesNotIgnoreLineFeed() {
        $test = (object)array(
            ...
            "source" => "Hi {name}:\n   you won a blue car",
            "context" => (object)array("name" => "Jairo"),
            "expected" => "Hi Jairo:\n   you won a blue car",
